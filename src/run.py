...
def run(_run, _config, _log):
    ...
    unique_token = "{}/{}__{}__{}__{}__{}__{}__{}".format(args.env, args.env, args.name, args.agent, "seed_"+str(args.seed), "k_percent_"+str(args.k_percent), "self_past_"+str(args.self_past), "k_past_neighbors_"+str(args.k_past_neighbors)) 
